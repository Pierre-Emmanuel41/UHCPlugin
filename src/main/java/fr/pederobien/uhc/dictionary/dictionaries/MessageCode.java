...
public enum MessageCode implements IMessageCode {
	...
	// Common scoreboard messages
	SCOREBOARD_CURRENT_GAME_TIME, SCOREBOARD_CURRENT_PAUSE_TIME,

	// Hunger game scoreboard messages
	SCOREBOARD_HUNGER_GAME_BORDER,

	// Blockedex game scoreboard messages
	SCOREBOARD_BLOCKEDEX_GAME_NORTH_BASE, SCOREBOARD_BLOCKEDEX_GAME_SOUTH_BASE, SCOREBOARD_BLOCKEDEX_GAME_EAST_BASE, SCOREBOARD_BLOCKEDEX_GAME_WEST_BASE,
	...
	RESET_BASE_EXPLANATION, RESET_BASE_MESSAGE,
	...
	LAUNCH_SPAWN_EXPLANATION, LAUNCH_SPAWN_LAUNCHED, LAUNCH_SPAWN_NOT_EXISTING, LAUNCH_SPAWN_MISSING_COORDINATES, LAUNCH_SPAWN_MISSING_NAME_AND_COORDINATES,
	...
	PLAYER_SPAWN_EXPLANATION, PLAYER_SPAWN_DEFINED, PLAYER_SPAWN_MISSING_COORDINATES,
	...
	RESET_SPAWN_EXPLANATION, RESET_SPAWN_MESSAGE,
	...
	SCOREBOARD_REFRESH_EXPLANATION, SCOREBOARD_REFRESH_NEGATIVE_TIC_DEFINED, SCOREBOARD_REFRESH_ONE_TIC_DEFINED, SCOREBOARD_REFRESH_TICS_DEFINED,
	SCOREBOARD_REFRESH_MISSING_TICS, SCOREBOARD_REFRESH_BAD_TICS_FORMAT, SCOREBOARD_REFRESH_TAB_COMPLETE,

	TEAM_EXPLANATION, TEAM_BAD_TEAM, TEAM_BAD_PLAYER, TEAM_BAD_COLOR, TEAM_ALREADY_EXISTING_TEAM_COLOR, TEAM_ALREADY_EXISTING_TEAM_NAME, TEAM_FORBIDDEN_NAME,
	TEAM_PLAYER_ALREADY_IN_TEAM,

	TEAM_ADDPLAYER_EXPLANATION, TEAM_ADDPLAYER_NO_PLAYER_ADDED, TEAM_ADDPLAYER_ONE_PLAYER_ADDED(MessagePermission.ALL),
	TEAM_ADDPLAYER_PLAYERS_ADDED(MessagePermission.ALL),

	TEAM_ADDTEAM_EXPLANATION, TEAM_ADDTEAM_TEAM_NO_PLAYER_ADDED, TEAM_ADDTEAM_TEAM_ONE_PLAYER_ADDED(MessagePermission.ALL),
	TEAM_ADDTEAM_TEAM_PLAYERS_ADDED(MessagePermission.ALL), TEAM_ADDTEAM_MISSING_ARGUMENTS,

	TEAM_LIST_EXPLANATION, TEAM_LIST_NO_EXISTING_TEAM(MessagePermission.ALL), TEAM_LIST_ONE_EXISTING_TEAM(MessagePermission.ALL),
	TEAM_LIST_EXISTING_TEAMS(MessagePermission.ALL),

	TEAM_MODIFY_EXPLANATION, TEAM_MODIFY_COLOR_EXPLANATION, TEAM_MODIFY_COLOR_MODIFIED(MessagePermission.ALL), TEAM_MODIFY_COLOR_UNCHANGED, TEAM_MODIFY_NAME_EXPLANATION,
	TEAM_MODIFY_NAME_MODIFIED(MessagePermission.ALL), TEAM_MODIFY_NAME_UNCHANGED,

	TEAM_MOVEPLAYER_EXPLANATION, TEAM_MOVEPLAYER_MOVED(MessagePermission.ALL), TEAM_MOVEPLAYER_PLAYER_NOT_IN_TEAM,

	TEAM_RANDOMTEAM_EXPLANATION, TEAM_RANDOMTEAM_DISPATCHED(MessagePermission.ALL), TEAM_RANDOMTEAM_BAD_MAX_PLAYER_FORMAT, TEAM_RANDOMTEAM_MAX_PLAYER_NEGATIVE,
	TEAM_RANDOMTEAM_NOT_ENOUGH_TEAMS, TEAM_RANDOMTEAM_NOT_ENOUGH_PLAYERS, TEAM_RANDOMTEAM_ON_TAB_COMPLETE,

	TEAM_REMOVEPLAYER_EXPLANATION, TEAM_REMOVEPLAYER_NO_PLAYER_REMOVED, TEAM_REMOVEPLAYER_ONE_PLAYER_REMOVED(MessagePermission.ALL),
	TEAM_REMOVEPLAYER_PLAYERS_REMOVED(MessagePermission.ALL), TEAM_REMOVEPLAYER_PLAYER_NOT_IN_TEAM,

	TEAM_REMOVETEAM_EXPLANATION, TEAM_REMOVETEAM_NO_TEAM_REMOVED, TEAM_REMOVETEAM_ONE_TEAM_REMOVED(MessagePermission.ALL),
	TEAM_REMOVETEAM_TEAMS_REMOVED(MessagePermission.ALL), TEAM_REMOVETEAM_ALL_TEAMS_REMOVED(MessagePermission.ALL),
	...
	FINAL_BORDER_DIAMETER_HUNGER_GAME_MISSING_DIAMETER, FINAL_BORDER_DIAMETER_HUNGER_GAME_BAD_DIAMETER_FORMAT, FINAL_BORDER_DIAMETER_HUNGER_GAME_TAB_COMPLETE,
	...
	INITIAL_BORDER_DIAMETER_HUNGER_GAME_MISSING_DIAMETER, INITIAL_BORDER_DIAMETER_HUNGER_GAME_BAD_DIAMETER_FORMAT, INITIAL_BORDER_DIAMETER_HUNGER_GAME_TAB_COMPLETE,
	...
	RESET_HUNGER_GAME_EXPLANATION, RESET_HUNGER_GAME_MESSAGE,

	SAVE_HUNGER_GAME_EXPLANATION, SAVE_HUNGER_GAME_SAVED,

	SPEED_BORDER_HUNGER_GAME_EXPLANATION, SPEED_BORDER_HUNGER_GAME_DEFINED, SPEED_BORDER_HUNGER_GAME_LESS_THAN_1, SPEED_BORDER_HUNGER_GAME_MISSING_SPEED,
	...
	// On game messages
	TEAM_DEATH_MATCH, PVP_ENABLED, NO_MORE_RESURRECTION, MOVING_BORDER, PLAYER_MUST_GO_BACK_TO_THE_OVERWORLD, PLAYER_MUST_STAY_IN_THE_OVERWORLD,
	...
	PLAYER_RESPAWN_BLOCKEDEX_GAME_EXPLANATION, PLAYER_RESPAWN_BLOCKEDEX_GAME_NEGATIVE_DIAMETER, PLAYER_RESPAWN_BLOCKEDEX_GAME_DIAMETER_DEFINED,
	PLAYER_RESPAWN_BLOCKEDEX_GAME_BAD_DIAMETER_FORMAT, PLAYER_RESPAWN_BLOCKEDEX_GAME_MISSING_DIAMETER, PLAYER_RESPAWN_BLOCKEDEX_GAME_ON_TAB_COMPLETE,
	...
	RADIUS_AREA_ON_PLAYER_DIE_BLOCKEDEX_GAME_EXPLANATION, RADIUS_AREA_ON_PLAYER_DIE_BLOCKEDEX_GAME_NEGATIVE_DISTANCE,
	RADIUS_AREA_ON_PLAYER_DIE_BLOCKEDEX_GAME_RADIUS_DEFINED, RADIUS_AREA_ON_PLAYER_DIE_BLOCKEDEX_GAME_BAD_DISTANCE_FORMAT,
	RADIUS_AREA_ON_PLAYER_DIE_BLOCKEDEX_GAME_MISSING_DISTANCE, RADIUS_AREA_ON_PLAYER_DIE_BLOCKEDEX_GAME_TAB_COMPLETE,

	RADIUS_AREA_ON_PLAYER_KILL_BLOCKEDEX_GAME_EXPLANATION, RADIUS_AREA_ON_PLAYER_KILL_BLOCKEDEX_GAME_NEGATIVE_DISTANCE,
	RADIUS_AREA_ON_PLAYER_KILL_BLOCKEDEX_GAME_RADIUS_DEFINED, RADIUS_AREA_ON_PLAYER_KILL_BLOCKEDEX_GAME_BAD_DISTANCE_FORMAT,
	RADIUS_AREA_ON_PLAYER_KILL_BLOCKEDEX_GAME_MISSING_DISTANCE, RADIUS_AREA_ON_PLAYER_KILL_BLOCKEDEX_GAME_TAB_COMPLETE,
	...
	RESET_BLOCKEDEX_GAME_EXPLANATION, RESET_BLOCKEDEX_GAME_MESSAGE,

	SAVE_BLOCKEDEX_GAME_EXPLANATION, SAVE_BLOCKEDEX_GAME_SAVED,

	STEP_HEALTH_BLOCKEDEX_GAME_EXPLANATION, STEP_HEALTH_BLOCKEDEX_GAME_NEGATIVE_STEP, STEP_HEALTH_BLOCKEDEX_GAME_STEP_DEFINED, STEP_HEALTH_BLOCKEDEX_GAME_BAD_STEP_FORMAT,
	STEP_HEALTH_BLOCKEDEX_GAME_MISSING_STEP, STEP_HEALTH_BLOCKEDEX_GAME_ON_TAB_COMPLETE,

	// On cannot run an blockedex game style
	BAD_BASES_CONFIGURATION,

	// On game messages
	CHEST_IS_RESTRICTED, TEAM_ELIMINATED, CANNOT_DROP_ITEM_ITEM_FORBIDDEN, CANNOT_DROP_ITEM_ITEM_ALREADY_DROPPED, CANNOT_GET_ITEM_BACK,
